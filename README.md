...
Security log analyzer with filtering and statistics.

School Purpose Only.

## Overview

Logspire is a polished educational cybersecurity utility by LayerByte. It focuses on one practical defensive concept and keeps the implementation small enough for students to read, run, and understand.

Security logs become more useful when events can be filtered, counted, and summarized.

## Highlights

- Filters security-related log entries
- Computes simple statistics
- Keeps reports beginner-readable
...
- Local log files
- Keywords, levels, or time filters
...
```bash
git clone https://github.com/LayerByte/logspire.git
cd logspire
```
...
A log analysis summary with selected matching entries.
